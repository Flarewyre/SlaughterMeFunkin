	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico-speaker':
				...
				playAnim('shoot1');
			case 'follower':
				tex = Paths.getSparrowAtlas('characters/the_follower');
				frames = tex;
			...
			case 'greeter':
				tex = Paths.getSparrowAtlas('characters/greeter');
				frames = tex;
				animation.addByPrefix('idle', 'idle0', 24, false);
				animation.addByPrefix('singUP', 'up0', 24, false);
				animation.addByPrefix('singRIGHT', 'right0', 24, false);
			...
			case 'waiter':
				tex = Paths.getSparrowAtlas('characters/the_waiter');
				frames = tex;
				animation.addByPrefix('idle', 'idle0', 24, false);
				animation.addByPrefix('singUP', 'up0', 24, false);
				animation.addByPrefix('singRIGHT', 'right0', 24, false);
			...
			case 'abomination':
				tex = Paths.getSparrowAtlas('characters/abomination');
				frames = tex;
				animation.addByPrefix('idle', 'idle0', 24, false);
				animation.addByPrefix('singUP', 'up0', 24, false);
				animation.addByPrefix('singRIGHT', 'right0', 24, false);
