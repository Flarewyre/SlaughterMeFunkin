...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [['Tutorial'], ['Slaughter-Me-Street', 'Lurk-Inside', 'Mishmash']];
	...
	var weekNames:Array<String> = ["", "Slaughter Me Street",];
	...
	public function selectWeek()
	{
		if (weekUnlocked[1])
		{
			PlayState.storyPlaylist = weekData[1];
